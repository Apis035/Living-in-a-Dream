...
namespace StorybrewScripts
{
    public class Spectrum : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            int startTime = -27;
            int EndTime   = 213766;
            var bitmap    = GetMapsetBitmap(BAR);
            ...
            for (var i=0; i<BarCount/3; i++)
            {
                ...
                var sprite = layer.CreateSprite("sb/8.png", OsbOrigin.Centre, new Vector2(325 - totalWidth/2 + i * barWidth, Pos.Y));
                sprite.CommandSplitThreshold = 500;
